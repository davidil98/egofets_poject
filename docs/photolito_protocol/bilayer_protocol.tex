...
A \textbf{bilayer resist stack} consisting of:
\begin{itemize}
...
\textbf{discontinuous} at the resist edges, allowing the solvent to
...
DMSO & Dimethyl sulfoxide, ULSI grade & To purchase \\
...
The bilayer lift-off process consists of the following major steps:

\begin{enumerate}[label=\textbf{Step \arabic*:}, leftmargin=3cm]
    \item Substrate preparation and mounting
    \item PMGI SF5 coating and prebake
    \item S1813 coating and soft bake
    \item Exposure (Microwriter ML3)
    \item Development (single-step, MF-319)
    \item Cr/Au evaporation
    \item DMSO lift-off
    \item Post-lift-off cleaning
\end{enumerate}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{0.5cm}
\textbf{Schematic: Bilayer Lift-Off Principle}\\[0.3cm]
\begin{tabular}{ccc}
\fbox{\parbox{2.5cm}{\centering\vspace{0.8cm}Au Au Au\\S1813 S1813\\PMGI PMGI\\---substrate---\vspace{0.3cm}}} &
\fbox{\parbox{2.5cm}{\centering\vspace{0.8cm}Au\phantom{X}Au\\S1813\phantom{X}S1813\\PMGI\textcolor{red}{\textbf{\textunderscore\textunderscore}}PMGI\\---substrate---\vspace{0.3cm}}} &
\fbox{\parbox{2.5cm}{\centering\vspace{0.8cm}\textcolor{green!50!black}{\textbf{Au}}\phantom{XX}\textcolor{green!50!black}{\textbf{Au}}\\S1813\phantom{XX}S1813\\PMGI\textcolor{red}{\textbf{\textunderscore\textunderscore\textunderscore}}PMGI\\---substrate---\vspace{0.3cm}}} \\
(a) Before develop & (b) After develop & (c) After evaporation
\end{tabular}
\vspace{0.3cm}
\par\smallskip
(a) Bilayer stack before development. (b) PMGI dissolves isotropically,
creating undercut (red dashes). (c) Metal is discontinuous at resist edges;
lift-off removes unwanted metal cleanly.
\vspace{0.3cm}}}
\caption{Bilayer lift-off process schematic.}
\end{figure}
...
\begin{enumerate}[label=\alph*)]
    \item Cut Kapton foil to \SI{7}{\cm} $\times$ \SI{7}{\cm} pieces.
          Allow cut pieces to flatten on a clean surface for 2--3 days
          before use to avoid ridges.
    ...
    \item Mount the Kapton on a clean Si carrier wafer using Kapton
          adhesive tape strips at the edges. Leave \textbf{gaps} between
...
The prebake temperature is the \textbf{primary control} for undercut rate.
...
\begin{enumerate}[label=\alph*)]
    ...
    \item Soak for \SIrange{2}{3}{\hours}. Swirl gently every
          \SI{30}{\min}.
...
\begin{enumerate}[label={[\arabic*]}]
    \item MicroChem Corp. \textit{PMGI Resists --- Technical Data Sheet}.
          Kayaku Advanced Materials, 2021. Available:
          \url{https://kayakuam.com/product/structsure/lift-off-resists}

    \item MicroChem Corp. \textit{LOR Lift-Off Resists --- Technical Data
          Sheet}. Kayaku Advanced Materials, 2021.

    \item MicroChemicals GmbH. \textit{DMSO (ULSI) --- Product
          Information}. Available:
          \url{https://www.microchemicals.com}

    \item Nanyte. \textit{Lift-off lithography, step by step}. Tutorial,
          2025--2026. Available:
          \url{https://nanyte.com/photoresist-tutorials/lift-off}

    \item Bonafe, F.P. et al. ``Dissipative charge transport in organic
          mixed ionic-electronic conductor channels.'' \textit{Nature
          Communications} \textbf{16}, 4537 (2025).
          \doi{10.1038/s41467-025-57528-9}

    \item Ruiz-Molina, S. PhD Thesis, ICMAB-CSIC, 2024. ``EGOFETs for
          biosensing.'' Chapter 3, Section 2.2.

    \item Ricci, S. PhD Thesis, ICMAB-CSIC, 2020. ``Organic
          electrochemical transistors for biosensing.'' Chapter 6.

    \item Fraunhofer IPMS. ``OFET Substrates --- Test Chips for Material
          Characterization.'' Protocol for resist removal, 2026.

    \item University of Minnesota Nano Center. ``PMMA/PMGI Bilayer E-Beam
          Liftoff Process.'' Institutional protocol.
          \url{https://cse.umn.edu/mnc}
\end{enumerate}
